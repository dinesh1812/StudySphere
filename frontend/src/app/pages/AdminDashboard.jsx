...
export function AdminDashboard() {
  ...
  const currentList = activeTab === 'pending' ? pendingStudents : approvedStudents;
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-card border border-border rounded-lg shadow-sm overflow-hidden">
        ...
        <div className="p-4 border-b border-border flex items-center gap-2">
          ...
          />
          <button
            onClick={activeTab === 'pending' ? fetchPendingStudents : fetchApprovedStudents}
          ...
          {isLoading ? (
            ...
            <div className="p-10 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                {searchQuery ? 'No students match your search.' : activeTab === 'pending' ? 'No pending approvals!' : 'No approved students yet.'}
              </p>
            </div>
          ) : (
